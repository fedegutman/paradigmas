...
linkR (Reg cities links tuneles) cityA cityB quality | (cityA `notElem` cities) || (cityB `notElem` cities) = error "Al menos una de las dos ciudades no está en la región."
